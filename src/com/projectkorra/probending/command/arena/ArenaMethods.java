...
public class ArenaMethods {
	...
	public static String getArenaSetupHelp(Arena arena) {
		if (arena.getTeamOneSpawn() == null) {
			...
			return PBMethods.Prefix + ChatColor.GREEN + "Use " + ChatColor.DARK_AQUA + "/pb arena setzone <Arena> Divider <Region> " + ChatColor.GREEN + "to set the region for the dividing line.";
		}
