...
public class FFProbendingField extends FileManager {
	...
	public List<ProbendingField> loadFields() {
		...
		for (String fieldKey : fieldList.getKeys(false)) {
			...
			fields.add(new ProbendingField(name, team1Spawns, team2Spawns, team1Loc1, team1Loc2, team1Loc3, team1KnockOff, team2Loc1, team2Loc2, team2Loc3, team2KnockOff, team1DMLoc, team2DMLoc, team1RG1, team1RG2, team1RG3, team2RG1, team2RG2, team2RG3, knockOff, deathMatch));
		}
