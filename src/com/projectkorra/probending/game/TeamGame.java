...
public class TeamGame extends Game{
	...
	public TeamGame(JavaPlugin plugin, ProbendingHandler handler, GameType type, GameMode mode, ProbendingField field, Set<Player> team1Players, Set<Player> team2Players, PBTeam team1, PBTeam team2) {
