...
public class PBMessenger {
	...
	public enum PBMessage {
		...
		BLANK("", false), DEFAULT_LINE(ChatColor.GOLD + "--------------------------------------------------", false), ERROR(ChatColor.RED + "ERROR, something went wrong!", true), NOPLAYER(ChatColor.RED + "No such player!", true), NOPERMS(ChatColor.RED + "You do not have enough permissions!", true), WRONGFORMAT(ChatColor.RED + "Incorrect usage!", true);
