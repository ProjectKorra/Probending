	...
	public static void configCheck(ConfigType type) {
		...
		switch (type) {
			...
			case MESSAGES:
				...
				//I'll do this later...
				/*
				 * config.addDefault("Messages.General.Prefix",
				 * "&7[&6Probending&7] ");
				 * config.addDefault("Messages.General.NoPermission",
				 * "&cYou dont have permission to do that.");
				 * config.addDefault("Messages.General.ConfigReloaded",
				 * "&aConfiguration reloaded.");
				 * config.addDefault("Messages.General.NoTeamPermissions",
				 * "&cYou dont have permission for any team commands.");
				 * 
				 ...
				 * config.addDefault(
				 * "Messages.Player.RemovedFromTeamBecauseDifferentElement",
				 * ""); config.addDefault(
				 * "Messages.Player.RemovedFromTeamBecauseNoElement", "");
