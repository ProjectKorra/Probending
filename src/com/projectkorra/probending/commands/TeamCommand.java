...
public class TeamCommand extends PBCommand {
	...
	public void execute(CommandSender sender, List<String> args) {
		...
		if (args.size() == 0) {
			List<String> help = Arrays.asList("&6/probending team create [name] [role] [color1] {color2} {color3} {color4} &eCreate a team and choose your role, and select the team colors!", "&6/probending team invite [player] [role] &eInvite a player to your team for a certain role!", "&6/probending team join [team] &eJoin a team. You can only join one that has invited you!", "&6/probending team leave &eLeave your current team!", "&6/probending team kick [player] &eKick a player from your team! &cLeader only!", "&6/probending team setname [name] &eChange the name of your team!", "&6/probending team setcolor [#(0-3)] [color] &eChange the color of a gear piece! /pb colors for color list. &cLeader only!", "&6/probending team setmemberrole [player] [role] &eChange the role of a member! &cLeader only!");
