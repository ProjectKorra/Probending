...
public class ProbendingField {
	...
	public ProbendingField(String fieldName, Map<Integer, Location> team1StartLocs, Map<Integer, Location> team2StartLocs, Location team1Location1, Location team1Location2, Location team1Location3, Location team1KnockedOffLocation, Location team2Location1, Location team2Location2, Location team2Location3, Location team2KnockedOffLocation, Location team1DMLocation, Location team2DMLocation, String team1Field1, String team1Field2, String team1Field3, String team2Field1, String team2Field2, String team2Field3, String knockOffArea, String deathMatchArena) {
	...
	public Boolean isFieldDone() {
		if (_fieldName.isEmpty() || _team1StartLocs.isEmpty() || _team2StartLocs.isEmpty() || _team1Location1 == null || _team1Location2 == null || _team1Location3 == null || _team1KnockedOffLocation == null || _team2Location1 == null || _team2Location2 == null || _team2Location3 == null || _team2KnockedOffLocation == null || _team1DMLocation == null || _team2DMLocation == null || _team1Field1 == null || _team1Field2 == null || _team1Field3 == null || _team2Field1 == null || _team2Field2 == null || _team2Field3 == null || _knockOffArea == null || _deathMathArea == null) {
			return false;
		}
		return true;
	}
